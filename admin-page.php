        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><h5>Restaurant web portal</h5></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Restaurant Menu</h5>
              </div>
            </div>
          </div>
        </div>
...
<table>
				...
				<?php
					...
					echo '<select id="name" name="name" data-error=".errorTxt01"><option>Cakes</option><option>Cofeee</option><option>Samosa</option><option>Half Tea</option></select><div class="errorTxt01"></div></td>';					
