        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                        <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><h5>Reataurant Web Portal</h5></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Total Sales Done Product Wise'
    },
    subtitle: {
        text: 'Product Detail'
    },
    xAxis: {
        categories: ['Half Tea', 'Cofee', 'Cake', 'Samosa'],
        title: {
            text: null
        }
    },
